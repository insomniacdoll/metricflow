...
class MaxComputeExpressionRenderer(DefaultSqlExpressionRenderer):
    """Expression renderer for the MaxComputeSQL engine."""

    @property
    def double_data_type(self) -> str:
        """Custom double data type for the MaxComputeSQL engine"""
...
class MaxComputeSqlQueryPlanRenderer(DefaultSqlQueryPlanRenderer):
    """Plan renderer for the MaxComputeSQL engine."""

    EXPR_RENDERER = MaxComputeExpressionRenderer()
