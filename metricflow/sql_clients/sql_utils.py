...
from metricflow.sql_clients.maxcompute import MaxComputeSqlClient
...
def make_sql_client(url: str, password: str) -> SqlClient:  # noqa: D
    ...
    elif dialect == SqlDialect.MAXCOMPUTE:
        return MaxComputeSqlClient.from_connection_details(url, password)
